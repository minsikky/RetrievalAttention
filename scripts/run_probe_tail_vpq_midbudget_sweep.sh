...
run_one() {
  ...
  if [[ -f "${out_dir}/summary.json" ]]; then
    echo "[vpq_midbudget_sweep] skip existing ${name}"
    return
  fi
  echo "[vpq_midbudget_sweep] run ${name}"
...
run_one probe_tail_b14336_p17408_l050_vpq_blend100_128k_v1 14336 17408
run_one probe_tail_b15360_p17408_l050_vpq_blend100_128k_v1 15360 17408
run_one probe_tail_b15360_p18432_l050_vpq_blend100_128k_v1 15360 18432
run_one probe_tail_b16384_p17408_l050_vpq_blend100_128k_v1 16384 17408
run_one probe_tail_b12288_p17408_l050_vpq_blend100_128k_v1 12288 17408

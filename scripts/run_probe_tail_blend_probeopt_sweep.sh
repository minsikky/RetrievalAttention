...
run_one() {
  ...
  if [[ -f "${out_dir}/summary.json" ]]; then
    echo "[tail_blend_probeopt_sweep] skip existing ${name}"
    return
  fi
  echo "[tail_blend_probeopt_sweep] run ${name}"
...
run_one probe_tail_p18432_l050_blend025_origgrid_128k_v1 18432 0.25 fixed
run_one probe_tail_p18432_l050_blend050_origgrid_128k_v1 18432 0.50 fixed
run_one probe_tail_p18432_l050_blend075_origgrid_128k_v1 18432 0.75 fixed
run_one probe_tail_p18432_l050_probeopt_cap100_128k_v1 18432 1.00 probe_optimal
run_one probe_tail_p18432_l050_probeopt_cap075_128k_v1 18432 0.75 probe_optimal
run_one probe_tail_p17408_l050_probeopt_cap100_128k_v1 17408 1.00 probe_optimal
run_one probe_tail_p20480_l050_probeopt_cap100_128k_v1 20480 1.00 probe_optimal

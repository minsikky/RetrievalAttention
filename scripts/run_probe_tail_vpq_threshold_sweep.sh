...
CONF_BUDGETS="4096,8192,12288,14336,15360,16384,17408,18432,19456,20480,24576,28672,32768"
...
run_one() {
  ...
  if [[ -f "${out_dir}/summary.json" ]]; then
    echo "[vpq_threshold_sweep] skip existing ${name}"
    return
  fi
  echo "[vpq_threshold_sweep] run ${name}"
...
run_one probe_tail_b14336_p16384_l075_vpq_blend100_128k_v1 14336 16384 0.075
run_one probe_tail_b14336_p16384_l100_vpq_blend100_128k_v1 14336 16384 0.100
run_one probe_tail_b15360_p17408_l075_vpq_blend100_128k_v1 15360 17408 0.075
run_one probe_tail_b15360_p17408_l100_vpq_blend100_128k_v1 15360 17408 0.100
run_one probe_tail_p18432_l075_vpq_blend100_128k_v1 16384 18432 0.075

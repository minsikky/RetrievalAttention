...
run_one() {
  ...
  if [[ -f "${out_dir}/summary.json" ]]; then
    echo "[vpq_s4b8_equalbudget_sweep] skip existing ${name}"
    return
  fi
  echo "[vpq_s4b8_equalbudget_sweep] run ${name}"
...
run_one probe_tail_b8192_p8192_l100_vpq_s4b8_blend100_128k_v1 8192 0.100
run_one probe_tail_b10240_p10240_l100_vpq_s4b8_blend100_128k_v1 10240 0.100
run_one probe_tail_b12288_p12288_l100_vpq_s4b8_blend100_128k_v1 12288 0.100
run_one probe_tail_b14336_p14336_l050_vpq_s4b8_blend100_128k_v1 14336 0.050

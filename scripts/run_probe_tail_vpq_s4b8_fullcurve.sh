...
run_one() {
  ...
  if [[ -f "${out_dir}/summary.json" ]]; then
    echo "[vpq_s4b8_fullcurve] skip existing ${name}"
    return
  fi
  echo "[vpq_s4b8_fullcurve] run ${name}"
...
run_one probe_tail_b12288_p12288_l100_vpq_s4b8_fullcurve_v1 12288 0.100
run_one probe_tail_b8192_p8192_l100_vpq_s4b8_fullcurve_v1 8192 0.100
run_one probe_tail_b14336_p14336_l100_vpq_s4b8_fullcurve_v1 14336 0.100

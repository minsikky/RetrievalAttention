...
export DENSE_KV_DECODE_BLOCK_TOKENS="${DENSE_KV_DECODE_BLOCK_TOKENS:-262144}"
export DENSE_KV_STAGING_BUFFERS="${DENSE_KV_STAGING_BUFFERS:-2}"
export DENSE_KV_QUERY_BLOCK_TOKENS="${DENSE_KV_QUERY_BLOCK_TOKENS:-4096}"
export DENSE_KV_AV_TF32="${DENSE_KV_AV_TF32:-1}"

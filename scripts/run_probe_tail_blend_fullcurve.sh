...
run_one() {
  ...
  if [[ -f "${out_dir}/summary.json" ]]; then
    echo "[tail_blend_fullcurve] skip existing ${name}"
    return
  fi
  echo "[tail_blend_fullcurve] run ${name}"
...
run_one probe_tail_p18432_l050_blend085_fullcurve_v1 18432 0.85
run_one probe_tail_p19456_l050_blend085_fullcurve_v1 19456 0.85

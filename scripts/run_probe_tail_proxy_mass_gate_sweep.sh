...
run_one() {
  ...
  if [[ -f "${out_dir}/summary.json" ]]; then
    echo "[proxy_mass_gate_sweep] skip existing ${name}"
    return
  fi
  echo "[proxy_mass_gate_sweep] run ${name}"
...
run_one probe_tail_p17408_l050_pm980_128k_v1 16384 17408 0.980
run_one probe_tail_p17408_l050_pm985_128k_v1 16384 17408 0.985
run_one probe_tail_p18432_l050_pm980_128k_v1 16384 18432 0.980
run_one probe_tail_p18432_l050_pm985_128k_v1 16384 18432 0.985
run_one probe_tail_p18432_l050_pm990_128k_v1 16384 18432 0.990
run_one probe_tail_p19456_l050_pm985_128k_v1 16384 19456 0.985
run_one probe_tail_b12288_p14336_l050_pm985_128k_v1 12288 14336 0.985

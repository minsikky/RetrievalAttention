...
run_one() {
  ...
  if [[ -f "${out_dir}/summary.json" ]]; then
    echo "[tail_blend_refine_sweep] skip existing ${name}"
    return
  fi
  echo "[tail_blend_refine_sweep] run ${name}"
...
run_one probe_tail_p18432_l050_blend080_128k_v1 18432 0.80
run_one probe_tail_p18432_l050_blend085_128k_v1 18432 0.85
run_one probe_tail_p18432_l050_blend090_128k_v1 18432 0.90
run_one probe_tail_p18432_l050_blend095_128k_v1 18432 0.95
run_one probe_tail_p19456_l050_blend075_128k_v1 19456 0.75
run_one probe_tail_p19456_l050_blend085_128k_v1 19456 0.85
run_one probe_tail_p17408_l050_blend075_128k_v1 17408 0.75
run_one probe_tail_p17408_l050_blend085_128k_v1 17408 0.85

...
run_one() {
  ...
  if [[ -f "${out_dir}/summary.json" ]]; then
    echo "[vpq_tail_sweep] skip existing ${name}"
    return
  fi
  echo "[vpq_tail_sweep] run ${name}"
...
run_one probe_tail_p18432_l050_vpq_blend100_128k_v1 18432 1.00
run_one probe_tail_p18432_l050_vpq_blend085_128k_v1 18432 0.85
run_one probe_tail_p17408_l050_vpq_blend085_128k_v1 17408 0.85
run_one probe_tail_p19456_l050_vpq_blend085_128k_v1 19456 0.85

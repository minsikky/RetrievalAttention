...
CANONICAL_ENV_DEFAULTS: dict[str, str] = {
    ...
    "SELECTOR_PQ_JOINT_VPREFIX_TRANSIENT_BUDGET_MB": "1600",
    "SELECTOR_PQ_JOINT_MEMORY_TRACE": "0",
    "SELECTOR_PQ_JOINT_FROZENSIM_FUSED_VPREFIX": "0",
    ...
    "SELECTOR_PQ_JOINT_FROZENSIM_FUSED_VPREFIX_TOKPAR_BATCHED_GLUE_QDQ": "0",
    "SELECTOR_PQ_JOINT_FROZENSIM_FUSED_VPREFIX_TOKPAR_BATCHED_GLUE_SCORE_GRID": "0",
    "SELECTOR_PQ_JOINT_FROZENSIM_FUSED_VPREFIX_TOKPAR_BATCHED_GLUE_POLICY": "0",
    "SELECTOR_PQ_JOINT_FROZENSIM_FUSED_VPREFIX_TOKPAR_BATCHED_PARTIALS_VEC4": "0",
    "SELECTOR_PQ_JOINT_FROZENSIM_FUSED_RISK_SORT": "0",
    "SELECTOR_PQ_JOINT_FROZENSIM_COMPILE": "0",
    "SELECTOR_PQ_JOINT_FROZENSIM_BF16_VPREFIX": "0",
    "SELECTOR_PQ_JOINT_FROZENSIM_TF32_QK": "0",
...
DISALLOWED_DIAGNOSTIC_ENV_FLAGS: tuple[str, ...] = (
    ...
    "SELECTOR_PQ_JOINT_FROZENSIM_FUSED_VPREFIX",
    ...
    "SELECTOR_PQ_JOINT_FROZENSIM_FUSED_RISK_SORT",
    "SELECTOR_PQ_JOINT_FROZENSIM_COMPILE",
    "SELECTOR_PQ_JOINT_FROZENSIM_BF16_VPREFIX",
    "SELECTOR_PQ_JOINT_FROZENSIM_TF32_QK",

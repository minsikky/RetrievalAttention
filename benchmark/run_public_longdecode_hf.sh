...
SELECTOR_PQ_PRECOMPUTE_RANK_WEIGHTS="${SELECTOR_PQ_PRECOMPUTE_RANK_WEIGHTS:-1}"
SELECTOR_PQ_GEOMETRIC_THREADS="${SELECTOR_PQ_GEOMETRIC_THREADS:-512}"
SELECTOR_PQ_SELECTED_CODEWEIGHT_DELTAS="${SELECTOR_PQ_SELECTED_CODEWEIGHT_DELTAS:-1}"
SELECTOR_PQ_SELECTED_EXACT_LISTS="${SELECTOR_PQ_SELECTED_EXACT_LISTS:-1}"
SELECTOR_PQ_THRESHOLD_NATIVE_TOPK="${SELECTOR_PQ_THRESHOLD_NATIVE_TOPK:-1}"
SELECTOR_PQ_THRESHOLD_TOPK="${SELECTOR_PQ_THRESHOLD_TOPK:-16384}"
ENABLE_FUSED_GEOMETRIC_OUTPUT="${ENABLE_FUSED_GEOMETRIC_OUTPUT:-1}"
SELECTOR_PQ_FUSED_DIM_SCAN_OUTPUT="${SELECTOR_PQ_FUSED_DIM_SCAN_OUTPUT:-1}"
export SELECTOR_PQ_PRECOMPUTE_RANK_WEIGHTS
export SELECTOR_PQ_GEOMETRIC_THREADS
export SELECTOR_PQ_SELECTED_CODEWEIGHT_DELTAS
export SELECTOR_PQ_SELECTED_EXACT_LISTS
export SELECTOR_PQ_THRESHOLD_NATIVE_TOPK
export SELECTOR_PQ_THRESHOLD_TOPK
export ENABLE_FUSED_GEOMETRIC_OUTPUT
export SELECTOR_PQ_FUSED_DIM_SCAN_OUTPUT
...
echo "[INFO] TASK_OFFSET=${TASK_OFFSET}"
...
echo "[INFO] SELECTOR_PQ_THRESHOLD_NATIVE_TOPK=${SELECTOR_PQ_THRESHOLD_NATIVE_TOPK}"
echo "[INFO] SELECTOR_PQ_GEOMETRIC_THREADS=${SELECTOR_PQ_GEOMETRIC_THREADS}"
